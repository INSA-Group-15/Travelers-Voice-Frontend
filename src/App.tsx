...
const IssueReportForm = lazy(
  () => import("./components/Report/IssueReportForm.tsx")
);
...
const MotionAnimatePresence: React.FC<AnimatePresenceProps> = ({
  children,
  ...props
}) => {
...
const ProtectedRoute: React.FC<{ children: React.ReactNode }> = ({
  ...
  return (
    ...
    >
      <motion.div variants={contentVariants} className="flex-1 flex flex-col">
        {children}
      </motion.div>
    </motion.div>
  );
