...
const mockReports: IssueReport[] = [
  {
    ...
    title: "Driver charging extra fare",
    description:
      "Bus driver at Downtown Station charging 50 Birr instead of 35 Birr for standard fare.",
    status: "pending",
    priority: "high",
  ...
  },
  {
    ...
    title: "Bus delayed ",
    description:
      "Route 15 bus has been delayed for 45 minutes with no explanation or updates.",
    status: "in_progress",
    priority: "medium",
    reportedBy: "Anonymous",
  ...
  },
  {
    ...
    description:
      "The gas station at North Terminal has been out of fuel for 2 days.",
    status: "resolved",
    priority: "high",
    reportedBy: "Anonymous",
  ...
  },
  {
    ...
    description:
      "Two buses had a minor collision at the intersection near South Terminal.",
    status: "urgent",
    priority: "critical",
    reportedBy: "Anonymous",
...
export const addMockDate = (data) => {
  mockReports.push(data);
};
      ...
      const generateDashboardStats = (
        ...
        reports.forEach((report) => {
          if (report.location) {
            ...
            reportsByLocation[routeKey] =
              (reportsByLocation[routeKey] || 0) + 1;
          }
        });
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            {user?.role === "transportation_office" &&
              "Full dashboard access and analytics"}
            {user?.role === "traffic_police" &&
              "View and manage assigned alerts"}
            {user?.role === "bus_station_manager" &&
              "Track reports for your location"}
          </p>
        </div>
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center space-x-4 text-sm text-gray-500">
                        <div className="flex items-center space-x-1">
                          ...
                          <span>
                            {report.location
                              ? `${report.location.startStation} to ${report.location.endStation}`
                              : "Route not specified"}
                          </span>
                        </div>
                        <div className="flex items-center space-x-1">
